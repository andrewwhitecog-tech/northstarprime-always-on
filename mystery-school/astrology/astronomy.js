...
(function (root, factory) {
  ...
  const PRESETS = {
    ...
    andy_dad: {
      name: 'Andy (Father — Cosmic Messenger · Milwaukee, WI)',
      year: 1972,
      month: 3,
      day: 16,
      hour: 12,
      ...
      description: '26° Pisces Sun on Midheaven, 14° Aries Moon conjunct Andre\'s 10° Aries Mars; 16° Libra Uranus trine Andre\'s 18° Aquarius Saturn; Great Lakes anchor.'
    },
    stephanie_mom: {
      name: 'Stephanie (Mother — Microprocessor Dawn · Corvallis, OR)',
      year: 1971,
      month: 12,
      day: 6,
      hour: 12,
      ...
      description: '14° Sagittarius Sun, 26° Aquarius Ascendant, 15° Aquarius Venus conjunct Andre\'s Saturn; 13° Taurus Mercury exact conjunction to Andre\'s 13° Taurus Venus; southern Willamette Valley anchor.'
    },
    lauren_father: {
      name: "Lauren's Father (Bob · San Francisco, CA)",
      year: 1951,
      month: 6,
      day: 5,
      hour: 12,
      ...
      description: '14° Gemini Sun, 26° Gemini Moon, 28° Taurus Midheaven conjunct Andre\'s 29° Taurus Sun; 18° Libra Venus & Neptune completing the 18° Grand Air Trine; Pacific maritime anchor.'
    },
    lauren_mother: {
      name: "Lauren's Mother (Susan · McMinnville, OR)",
      year: 1956,
      month: 4,
      day: 15,
      hour: 12,
      ...
      tzOffset: -8,
      location: 'McMinnville, Oregon',
      description: '26° Aries Sun, 28° Gemini Moon, 29° Scorpio Saturn exact 0.01° polarity anchor to Andre\'s 29° Taurus Sun; mother-daughter McMinnville generational origin.'
    },
    ill_bill: {
